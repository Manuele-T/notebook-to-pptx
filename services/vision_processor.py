...
# Use Gemini 3.0 Flash (Preview) - mapping to gemini-3.0-flash as the currently available equivalent or identifier
...
def analyze_slide_image(image: Image.Image) -> dict:
    ...
    try:
        ...
        # Fail gracefully with a default structure if the AI output is malformed
        return {
